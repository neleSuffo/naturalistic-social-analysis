...
#### Multi-label exhaustive annotation
The dataset contains annotations for each video clip, including the start and end times of the activity, the activity class as well as the current location of the child in the video. 
...
\ref{tab:table_train_val_test} provides an overview of the number of clips per class in the training, validation, and testing sets.
