from src.social_interaction.constants import DetectionPaths, DetectionParameters
from src.social_interaction.my_utils import (
    create_video_writer,
    detection_coco_output,
    detection_video_output,
)
from src.social_interaction.config import generate_detection_output_video
...
def run_person_detection(
    ...
    The detection results are returned in COCO format.
