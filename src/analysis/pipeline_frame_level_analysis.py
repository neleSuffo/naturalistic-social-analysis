...
def main(db_path: Path, output_dir: Path, hyperparameter_tuning: bool = False, video_list = None, included_rules: list = None, mode: str = "tertiary") -> dict:
    """
    ...
    if video_list is None:
        ...
        processed_videos = video_list # Use the fold-specific list
...
if __name__ == "__main__":    
    ...
    parser.add_argument('--video_list', type=str, nargs='+', default=None,
                        help='Specific videos to process for this run.')
    ...
    main(db_path=Path(DataPaths.INFERENCE_DB_PATH), output_dir=Inference.BASE_OUTPUT_DIR, included_rules=args.rules, video_list=args.video_list, hyperparameter_tuning=False, mode=args.mode)