...
def parse_args():
    ...
    parser.add_argument('--device', type=str, default='0,1', help='Device to use (e.g., "0" for GPU, "cpu" for CPU)')
...
def main():
    ...
    if args.retrain:
        ...
        if args.type == "classification":
            model = YOLO(f"{PersonConfig.MODEL_NAME}.pt")
    ...
    model.train(
        ...
        patience=PersonConfig.PATIENCE,
        workers=PersonConfig.NUM_WORKERS,
        device=args.device,
        cos_lr=True,
        degrees=PersonConfig.DEGREES,
