...
model.train(
    data=str(YoloPaths.person_face_data_config_path),
    epochs=200,  # Total number of epochs
    imgsz=640,  # Image size
    batch=16,   # Batch size
    project=str(YoloPaths.person_face_output_dir),  # Output directory
...
script_copy = output_dir / "train_yolo_person_face.py"
