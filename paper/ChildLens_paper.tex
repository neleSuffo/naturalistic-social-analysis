...
{\centering \includegraphics[width=5.49in]{activity_classes} 

}

\caption{Vest with the embedded camera worn by the children}\label{fig:activity-classes}
\end{figure}
