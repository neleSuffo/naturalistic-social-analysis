...
The ChildLens dataset consists of egocentric videos recorded by children aged 3 to 5 years. A total of xx children from families in Leipzig, Germany, participated in the study. The videos were captured at home using a camera embedded in a vest worn by the children. This setup allows the children to move freely around the house or apartment while recording their activities. The camera records everything that happens in front of the child, while a microphone captures the sound. Additionally, the parents were handed a small checklist of activities to record, ensuring that a variety of activities were captured in the videos. The focus was on everyday activities that children typically engage in, such as playing with toys, reading books, or drawing.

\subsection{Step 2: Creation of Labeling Strategy}\label{step-2-creation-of-labeling-strategy}

\subsection{Step 2: Manual Labeling Process}\label{step-2-manual-labeling-process}
