...
### Implementation Details
The Voice Type Classifier was applied to the ChildLens dataset. A total of `r num_audio_files` raw files, with a total duration of `r sum_hours`, were processed by the model in `r vtc_minutes_run` minutes. 
