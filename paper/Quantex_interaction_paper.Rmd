...
person_fpr = (person_fp / (person_fp + person_tn)) * 100
person_fnr = (person_fn / (person_fn + person_tp)) * 100
...
my.data <- "Class             | Percentage  | Training  | Validation  | Testing | Total Occurances
...
```{r person-metrics, fig.align='center', fig.cap="\\textbf{A} - Confusion Matrix for the YOLO11x detection model trained on the Quantex dataset. \\textbf{B} - Precision-Recall Curve for the YOLO11x detection model."}
# Load images
