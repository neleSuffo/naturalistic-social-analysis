...
apa_table(
  df,
  caption = "Evaluation metrics for the YOLO11x-cls gaze classification model, showing precision, recall, and F1-score for detecting if a person is looking at the key child.",
  escape = TRUE
)
```
