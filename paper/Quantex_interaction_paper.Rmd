...
# Introduction
	1.	Contextualize Early Childhood Social Development
	
According to various developmental psychologists, children’s everyday experiences play a vital role in their development [@piagetPartCognitiveDevelopment1964; @vygotskyMindSocietyDevelopment1978; @rogoffImportanceUnderstandingChildrens2018; @carpendaleWhatMakesUs2020; @smithDevelopingInfantCreates2018; @tomaselloCulturalOriginsHuman2009; @heyesCognitiveGadgetsCultural2018]. Everyday interactions, in particular, have been recognized for decades as crucial in the process of actively constructing knowledge [@piagetPartCognitiveDevelopment1964] and in transforming sensory experiences into structured understanding [@vygotskyMindSocietyDevelopment1978]. Building upon these foundational theories, more recent research has examined the mechanisms of social interaction further. For instance, Michael Tomasello introduced the concept of shared intentionality, illustrating how collaborative activities enable children to comprehend others’ intentions and perspectives, leading to cooperative behaviors and cultural learning [@tomaselloCulturalOriginsHuman2009].

		2.	Identify the Research Gap
While theoretical approaches and controlled laboratory studies have significantly advanced our understanding of children’s social development, they often fail to capture the complexities of interactions occurring in naturalistic home settings. Observing children in their everyday environments provides a more authentic view of their social behaviors, yet this approach presents challenges due to the extensive data collection and analysis required. Conducting large-scale studies in naturalistic settings is labor-intensive and time-consuming. Manual data collection and analysis can be particularly daunting, often limiting the scope and scale of such research. These challenges have severely restricted the accumulation of comprehensive datasets that accurately reflect children’s natural social behaviors in complex environments. 

Despite these challenges, numerous research have utilized data-driven approaches to investigate children’s social interactions:
Onnela et. al [@onnelaUsingSociometersQuantify2014] investigated social interactions in two different adult work settings utilized sensors capturing for how long two individuals were close to each other. Rossano et. al 5@rossanoHow24yearold2022] studied 31 two- to four-year-old's social interactions using 563 hours of video and audio recordings from a preschool during free play session over the course of 7 days. Based on manual interaction labels they found that four-year-olds engage in more cooperative social interactions while also fighting less than two-year-olds. The most common forms of social engagement in both age groups were playing with objects and conversations. 


Dai et. al [@daiLongitudinalDataCollection2022] investigated social and oral interactions of children in pre-school setting over several years. They collected voice and distance using wearable wireless RFID tags to study how socialization and language acquisition develop side by side. One of the findings based on this data was that age difference significantly influences the interaction duration. Akcakir et. al [@akcakirExploringInterplayIndividual2024] approximated social interactions using spatial proximity sensors and the amount of time spent close to another child for children in preschool. One of the key findings was that age difference significantly influences the interaction duration. Lemaignan et. al [@lemaignanPInSoRoDatasetSupporting2018] created a dataset of social interactions between children and robots. The dataset comprises 45 hours of manually labeled data of social interactions between 45 child-child pairs and 30 child-robot pairs. The dataset includes video and audio recordings, 30 3D face recordings, skeletal information, and game interactions. The focus of the dataset is on a naturalistic setting, with no instructions given, but limited to 40 minutes.

	3.	Introduce the Study’s Focus
...
[@daiLongitudinalDataCollection2022] investigated social and oral interactions of children in pre-school setting over several years.collected voice and distance using wearable wireless RFID tags to study how socialisation and langauge acquisition develops side by side

one of the findings based on this data:
[@akcakirExploringInterplayIndividual2024] approximate Social interactions using spatial proximity sensors and the amount of time spent close to another child for children in pre school, one of the key findings was that
age difference significantly influences the interaction duration



[@lemaignanPInSoRoDatasetSupporting2018]: 
- 45h of manually labeled data of social interactions between 45 child-child pairs and 30 child-robot pairs
- dataset comprises video and audio recordings, 30 3D face recordings, skeletal information and game interactions
- focus on naturalistic setting, no instructions given, but limited to 40 minutes


	
	
	3.	Introduce the Study’s Focus
	•	Present the specific patterns of social interactions under investigation:
	•	Presence of individuals (person detection)
	•	Facial engagements (face detection)
	•	Objects the child interacts with (object detection)
	•	Speech dynamics (voice type classification)
	•	Gaze behaviors, particularly when others look at the child (gaze classification)
	
	
	4.	Articulate the Research Objectives
	•	State the aim to quantify the frequency of each interaction pattern, both individually and in combination.
	•	Express the intent to compare these patterns across different age groups within the 3-5 year range to identify developmental variations.
	
	
	5.	Highlight the Study’s Significance
	•	Discuss how understanding these interaction patterns can inform developmental psychology, early childhood education, and parenting strategies.
	•	Suggest potential applications of the findings in designing interventions or educational programs tailored to specific developmental needs.
...
- what is out there regarding social interaction




we analyze the Quantex dataset regarding different aspect of social interactions and look at the presence and combination of general interactions patterns like the presence of persons, faces, gaze, and objects in children's everyday interactions. We furthermode investigate how those interaction aspects change over time and how they are related to the child's age. We trained a YOLO11 model to detect persons and faces in the videos and analyzed the presence of gaze and objects in the videos. We furthermore applied a pre-trained voice type classifier to detect speech in the audio data. 
