...
- available were modes for direct gaze estimation like LiteGaze [@guoLiteGazeNeuralArchitecture2023] or 
...
```{r proximity-classifications, echo=FALSE, dpi=600, fig.align='center', fig.cap="Proximity heuristic examples. Example \\textbf{A} shows a face close to the camera, while example \\textbf{B} depicts a face further away."}
img1 <- ggdraw() + draw_image("images/face_close.jpg", scale = 0.95)
img2 <- ggdraw() + draw_image("images/face_close.jpg", scale = 0.95)
img3 <- ggdraw() + draw_image("images/face_close.jpg", scale = 0.95)
img4 <- ggdraw() + draw_image("images/face_close.jpg", scale = 0.95)
