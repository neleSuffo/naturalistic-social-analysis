...
Onnela et. al (Onnela, Waber, Pentland, Schnorf, \& Lazer, 2014) investigated social interactions in two different adult work settings utilized sensors capturing for how long two individuals were close to each other. Rossano et. al \href{mailto:5@rossanoHow24yearold2022}{\nolinkurl{5@rossanoHow24yearold2022}}{]} studied 31 two- to four-year-old's social interactions using 563 hours of video and audio recordings from a preschool during free play session over the course of 7 days. Based on manual interaction labels they found that four-year-olds engage in more cooperative social interactions while also fighting less than two-year-olds. The most common forms of social engagement in both age groups were playing with objects and conversations.

Dai et. al (Dai et al., 2022) investigated social and oral interactions of children in pre-school setting over several years. They collected voice and distance using wearable wireless RFID tags to study how socialization and language acquisition develop side by side. One of the findings based on this data was that age difference significantly influences the interaction duration. Akcakir et. al (Akçakır et al., 2024) approximated social interactions using spatial proximity sensors and the amount of time spent close to another child for children in preschool. One of the key findings was that age difference significantly influences the interaction duration. Lemaignan et. al (Lemaignan, Edmunds, Senft, \& Belpaeme, 2018) created a dataset of social interactions between children and robots. The dataset comprises 45 hours of manually labeled data of social interactions between 45 child-child pairs and 30 child-robot pairs. The dataset includes video and audio recordings, 30 3D face recordings, skeletal information, and game interactions. The focus of the dataset is on a naturalistic setting, with no instructions given, but limited to 40 minutes.

\begin{verbatim}
3.  Introduce the Study’s Focus
\end{verbatim}

(Dai et al., 2022) investigated social and oral interactions of children in pre-school setting over several years.collected voice and distance using wearable wireless RFID tags to study how socialisation and langauge acquisition develops side by side

one of the findings based on this data:
(Akçakır et al., 2024) approximate Social interactions using spatial proximity sensors and the amount of time spent close to another child for children in pre school, one of the key findings was that
...
\bibitem[\citeproctext]{ref-akcakirExploringInterplayIndividual2024}
Akçakır, G., Azaiez, A., Ceria, A., Eminente, C., Ferranti, G., Gandhi, G., \ldots{} Iacopini, I. (2024). Exploring the interplay of individual traits and interaction dynamics in preschool social networks. \url{https://doi.org/10.48550/ARXIV.2407.12728}
